...
export default function App() {
    const [holiday, setHoliday] = useState("Enter a holiday in the form above");
    const [date, setDate] = useState("Enter a date in the form above");
    ...
    return (
        <div className="container">
            ...
            <h2 id="favourite-holiday">
                Please tell us your favourite holiday!
            </h2>
            <form
                className="form"
